...
- intent: 记录一个新问题到 .pt/docs/issues/{{issue-name}}.md
- vars: [issue-name]
...
- step: 删 .pt/cache/contexts/pt-dev.context.md（让 issues domain 重新编译进 system prompt）
...
- vars: []
- step: 读 .pt/docs/issues/ 下所有 .md 的 frontmatter
